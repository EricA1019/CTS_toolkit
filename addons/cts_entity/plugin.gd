...
const SIGNAL_REGISTRY_NAME := "EntitySignalRegistry"
const SIGNAL_REGISTRY_PATH := "res://addons/cts_entity/Core/entity_signal_registry.gd"
...
func _enable_plugin() -> void:
	...
	if not Engine.has_singleton(SIGNAL_REGISTRY_NAME):
		add_autoload_singleton(SIGNAL_REGISTRY_NAME, SIGNAL_REGISTRY_PATH)
...
func _disable_plugin() -> void:
	...
	if Engine.has_singleton(SIGNAL_REGISTRY_NAME):
		remove_autoload_singleton(SIGNAL_REGISTRY_NAME)
