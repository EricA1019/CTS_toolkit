...
# Godot Unit Test lifecycle hooks
func before_all() -> void:
    if enabled and has_method("init_suite"):
        init_suite()


func after_all() -> void:
    if enabled and has_method("cleanup_suite"):
        cleanup_suite()


func before_each() -> void:
    if enabled and has_method("init_test"):
        init_test()
    

func after_each() -> void:
    if enabled and has_method("cleanup_test"):
        cleanup_test()
